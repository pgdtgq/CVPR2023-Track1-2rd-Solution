...
class SwinTransformer(nn.Layer):
    ...
    def __init__(self,
        ...
        window_size =window_size
        # if pretrained:
        #     pretrained_path = MODEL_cfg[arch]['pretrained']
        ...
        if pretrained is not None:
            ...
            print('=========================================>load pretrained swin transformer successfully!')
    ...
    def forward(self, x):
        ...
        for i in range(self.num_layers):
            ...
            org_features.append(x_out)
            output_size.append([H, W])
            # print(x_out.shape, H, W)
        ...
        return [outs, org_features, output_size]
...
if __name__=='__main__':
    model = SwinTransformer(  #swin large
        arch ='swin_L_224',
        patch_size = 4,
        pretrain_img_size=224,
        embed_dim=192,
