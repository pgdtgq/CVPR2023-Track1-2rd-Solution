...
class SegSETRLoss(nn.Layer):
    def __init__(self, num_losses = 5, seg_loss_weight = 1.0):
        super(SegSETRLoss, self).__init__()
        self.num_losses = num_losses
        self.losses = [CrossEntropyLoss() for i in range( self.num_losses)]
        self.coef = [1.0, 0.4, 0.4, 0.4, 0.4]
...
# class SegSETRLoss2(nn.Layer):
#     def __init__(self, ):
#         super(SegSETRLoss2, self).__init__()
